    ...
    <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="p-4 bg-white w-full sm:w-96 flex gap-4 flex-col">
        ...
        >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="border border-slate-400 w-full rounded p-2 outline-orange-400"
              {...collect("fullname")}
            />
            {errors.fullname && (
          ...
          <div className="relative">
            <MdPassword
              className="text-slate-500 absolute top-3 right-2 text-xl cursor-pointer"
          ...
          <label
            ...
            className="text-sm text-slate-500 flex flex-col"
          >
            <span className="flex gap-2">
              <input type="checkbox" {...collect("terms")} />I agree to all{" "}
          ...
          {/* login button */}
          <button
            className={`bg-orange-600 text-white font-semibold text-sm py-2 rounded w-full hover:bg-orange-400 transition duration-300`}
          >
            Register
          </button>
        </form>
        ...
        <div className="w-full">
          {/* google signin */}
          <button className="bg-white text-black border border-slate-400 font-semibold text-sm py-2 rounded w-full flex items-center gap-2 justify-center transition-all hover:bg-orange-600 hover:text-white hover:border-none">
